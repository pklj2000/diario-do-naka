...
running command...
$ bohr (--version)
bohr/1.0.577 linux-x64 node-v16.20.2
$ bohr --help [COMMAND]
USAGE
  $ bohr COMMAND
...
...
* [`bohr login [DEV]`](#bohr-login-dev)
* [`bohr logout`](#bohr-logout)
* [`bohr version`](#bohr-version)
...
_See code: [dist/commands/deploy.ts](https://github.com/bohr-io/cli/blob/v1.0.577/dist/commands/deploy.ts)_
...
_See code: [dist/commands/dev.ts](https://github.com/bohr-io/cli/blob/v1.0.577/dist/commands/dev.ts)_
...
```
USAGE
  $ bohr login [DEV] [-t <value>]

ARGUMENTS
  DEV  called from command bohr dev

FLAGS
  -t, --token=<value>  optional token

DESCRIPTION
  Login in your bohr.io account
```

_See code: [dist/commands/login.ts](https://github.com/bohr-io/cli/blob/v1.0.577/dist/commands/login.ts)_
...
_See code: [dist/commands/logout.ts](https://github.com/bohr-io/cli/blob/v1.0.577/dist/commands/logout.ts)_
...
_See code: [dist/commands/version.ts](https://github.com/bohr-io/cli/blob/v1.0.577/dist/commands/version.ts)_
<!-- commandsstop -->
